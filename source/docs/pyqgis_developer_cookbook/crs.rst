...
has been successful: `isValid() <https://qgis.org/pyqgis/3.0/core/Coordinate/QgsCoordinateReferenceSystem.html#qgis.core.QgsCoordinateReferenceSystem.isValid>`_ must return :const:`True`.
...
`QgsApplication.setPrefixPath() <https://qgis.org/pyqgis/3.0/core/other/QgsApplication.html#qgis.core.QgsApplication.setPrefixPath>`_ otherwise it will fail to find the
...
`transform() <https://qgis.org/pyqgis/3.0/core/Coordinate/QgsCoordinateTransform.html#qgis.core.QgsCoordinateTransform.transform>` function to do the transformation. By default it does forward

...
A `QgsExpressionContext <https://qgis.org/pyqgis/3.0/core/Expression/QgsExpressionContext.html>`_
...
You can also use `QgsExpression.prepare() <https://qgis.org/pyqgis/3.0/core/Expression/QgsExpression.html#qgis.core.QgsExpression.prepare>`_ if you need check more than
one feature.  Using `QgsExpression.prepare() <https://qgis.org/pyqgis/3.0/core/Expression/QgsExpression.html#qgis.core.QgsExpression.prepare>`_ will increase the speed
